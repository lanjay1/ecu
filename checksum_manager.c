...
// Contoh implementasi CRC16-CCITT (0x1021) - pilih polinomial yang sesuai kebutuhan
uint16_t Checksum_Calculate16(const uint8_t* data, uint32_t len) {
    uint16_t crc = 0xFFFF; // Atau 0x0000 tergantung standar CRC16
...
// Simple 8-bit checksum (untuk data kecil)
